...
public class AddStudent2Activity extends Activity implements View.OnClickListener {
    private static final String TAG = "AddStudent2Activity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bnSelect = (Button) findViewById(R.id.bn_select);
    ...
    private void showEditUI(Student student) {
        ...
        face.setImageBitmap(ImageUtils.bytesToBitmap(faceInfo));
        setTitle("学员信息更新");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null) {
            ...
            bitmap = ImageUtils.cropBitmap(bitmap);
//            bitmap = ImageUtils.zoomImg(bitmap, 100, 100);
//            bitmap = ImageUtils.resizeImage(bitmap, 100, 100);
            Log.e("asd", "长"+bitmap.getHeight()+",宽"+bitmap.getWidth());
            faceInfo = ImageUtils.bitmapToByte(bitmap);
