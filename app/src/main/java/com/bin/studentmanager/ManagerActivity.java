...
public class ManagerActivity extends ListActivity implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
...
//    }
    ...
    public void load() {
        ...
        adapter = new MySimpleCursorAdapter(this, R.layout.student_list_item,
        ...
        builder.setTitle("学员信息删除")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        load();
                        if (raws > 0) {
                            Toast.makeText(ManagerActivity.this, "删除成功!",
                                    Toast.LENGTH_LONG).show();
                        } else
                            Toast.makeText(ManagerActivity.this, "删除失败!",
                                    Toast.LENGTH_LONG).show();
                    }
                })
    ...
    public void onBackPressed() {
        ExitDialog dialog=new ExitDialog(ManagerActivity.this);
        dialog.show();
    }
}