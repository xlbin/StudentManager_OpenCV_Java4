...
import com.bin.studentmanager.Menbers.CommandConstants;
...
public class ImageProcessUtils {
    ...
    public static final String CUSTOM_BLUR_COMMAND = "blur";
    public static final String CUSTOM_EDGE_COMMAND = "edge";
    public static final String CUSTOM_SHARPEN_COMMAND = "share";
