package com.bin.studentmanager.view;
...
import com.bin.studentmanager.interfaces.OnFaceDetectorListener;
import com.bin.studentmanager.interfaces.OnOpenCVInitListener;
...
public class CameraFaceDetectionView extends JavaCameraView implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public boolean loadOpenCV(Context context) {
        // 初始化OpenCV
//        boolean isLoaded = OpenCVLoader.initAsync(OpenCVLoader.OPENCV_VERSION_3_4_0, context, mLoaderCallback);
//
//        if (isLoaded) {
//            // OpenCV加载成功
